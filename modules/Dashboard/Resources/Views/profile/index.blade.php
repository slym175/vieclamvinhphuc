                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ auth()->user()->avatar }}../img/user.jpg" class="rounded-circle" width="150" />
            ...
            <div class="col-lg-9 col-md-8">
                <div class="card">
                    <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active text-dark" id="pills-profile-tab" data-toggle="pill" href="#last-month" role="tab" aria-controls="pills-profile" aria-selected="false">{{ trans('app.profile') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark" id="pills-setting-tab" data-toggle="pill" href="#previous-month" role="tab" aria-controls="pills-setting" aria-selected="false">{{ trans('app.change_password') }}</a>
                        </li>
                    </ul>
