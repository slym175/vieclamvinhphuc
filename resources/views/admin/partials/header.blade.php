    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            ...
            <div class="top-menu d-flex align-items-center">
                ...
                {{--                                    <span class="d-block heading-font-family media-heading">Invitation accepted</span>--}}
                {{--                                    <span class="d-block media-content">Your have been Invited ...</span>--}}
                {{--                                </div>--}}
                {{--                            </a>--}}
                {{--                        </div>--}}
                ...
                {{--                <div class="dropdown">--}}
                {{--                    <a class="dropdown-toggle nav-link" href="#" id="settingsDropdown" role="button" data-toggle="dropdown"--}}
                {{--                       aria-haspopup="true" aria-expanded="false"><i class="ik ik-settings"></i></a>--}}
                ...
                {{--                </div>--}}
                <div class="dropdown">
                    <a class="dropdown-toggle d-flex justify-content-center align-items-center" href="#"
                       id="userDropdown" role="button" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false">
                        <img class="avatar" src="{{ asset('assets/admin/images/user.jpg') }}" alt="">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="{{ route_check('app.admin.site.index') }}">
